...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        kYSLScrollMenuViewWidth =  ([UIScreen mainScreen].bounds.size.width - 50)/3;
...
- (void)setItemTitleArray:(NSArray *)itemTitleArray
{
    if (_itemTitleArray != itemTitleArray) {
        ...
        for (int i = 0; i < itemTitleArray.count; i++) {
            ...
            itemView.lineBreakMode = NSLineBreakByWordWrapping;
...
- (void)layoutSubviews
{
    ...
    for (NSUInteger i = 0; i < self.itemViewArray.count; i++) {
        //   CGFloat width = kYSLScrollMenuViewWidth;     //  menu list width
